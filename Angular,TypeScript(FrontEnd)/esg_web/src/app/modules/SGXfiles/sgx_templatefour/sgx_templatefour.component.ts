...
@Component({
  selector: 'app-sgx_templatefour',
  templateUrl: './sgx_templatefour.component.html',
  styleUrls: ['./sgx_templatefour.component.scss']
})
export class Sgx_templatefourComponent implements OnInit {
