...
@Component({
  selector: 'app-social205c',
  templateUrl: './social205c.component.html',
  styleUrls: ['./social205c.component.scss']
})
export class Social205cComponent implements OnInit {
    ...
    this.sgx.GetSGX_ReportGenerationByReportId(this.reportid).subscribe((data) => {
      ...
      if (reportdata && reportdata.InitialDraftReport) {
        ...
        this.socialform.patchValue({
          social1: this.initialDraftReport[17]['social205cQuestion1'],
  ...
  onSave() {
  var social205cQuestion1 = this.socialform.get('social1').value;
  
  
    this.initialDraftReport[17] = {social205cQuestion1}
    // this.sgx.sgxanswers[17]=this.initialDraftReport;
    ...
    this.sgx.sgxanswers[17]=currentInitialDraftReport[17];
    ...
    this.sgx.GetSGX_ReportGenerationByReportId(this.reportid).subscribe((data) => {
        ...
        if(init!=null){
        init[17]=this.sgx.sgxanswers[17]
