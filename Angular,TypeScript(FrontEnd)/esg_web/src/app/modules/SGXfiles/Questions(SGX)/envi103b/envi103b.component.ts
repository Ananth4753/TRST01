...
@Component({
  selector: 'app-envi103b',
  templateUrl: './envi103b.component.html',
  styleUrls: ['./envi103b.component.scss']
})
export class Envi103bComponent implements OnInit {
    ...
    this.sgx.GetSGX_ReportGenerationByReportId(this.reportid).subscribe((data) => {
      ...
      if (reportdata && reportdata.InitialDraftReport) {
        ...
        this.enviroform.patchValue({
          Env1: this.initialDraftReport[5]['env103bQuestion1'],
          Env2: this.initialDraftReport[5]['env103bQuestion2'],
          Env3: this.initialDraftReport[5]['env103bQuestion3']
        });
      }
    });
  }
  ...
  onSave() {
    var env103bQuestion1 = this.enviroform.get('Env1').value;
    var env103bQuestion2 = this.enviroform.get('Env2').value;
    var env103bQuestion3 = this.enviroform.get('Env3').value;

    this.initialDraftReport[5] = {env103bQuestion1,env103bQuestion2,env103bQuestion3}
  // this.sgx.sgxanswers[5]=this.initialDraftReport;
  ...
  this.sgx.sgxanswers[5]=currentInitialDraftReport[5];
