...
@Component({
  selector: 'app-envi102a',
  templateUrl: './envi102a.component.html',
  styleUrls: ['./envi102a.component.scss']
})
export class Envi102aComponent implements OnInit {
    ...
    this.sgx.GetSGX_ReportGenerationByReportId(this.reportid).subscribe((data) => {
      ...
      if (reportdata && reportdata.InitialDraftReport) {
        ...
        this.enviroform.patchValue({
          Env1: this.initialDraftReport[2]['env102aQuestion1'],
          Env2: this.initialDraftReport[2]['env102aQuestion2']
        });
      }
    });
  }
  ...
  onSave() {
    var env102aQuestion1 = this.enviroform.get('Env1').value;
    var env102aQuestion2 = this.enviroform.get('Env2').value;
  
    this.initialDraftReport[2] = {env102aQuestion1,env102aQuestion2}
  ...
  this.sgx.sgxanswers[2]=currentInitialDraftReport[2];
