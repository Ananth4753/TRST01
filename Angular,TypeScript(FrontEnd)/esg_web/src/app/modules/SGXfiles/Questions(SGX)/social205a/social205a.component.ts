...
@Component({
  selector: 'app-social205a',
  templateUrl: './social205a.component.html',
  styleUrls: ['./social205a.component.scss']
})
export class Social205aComponent implements OnInit {
    ...
    this.sgx.GetSGX_ReportGenerationByReportId(this.reportid).subscribe((data) => {
      ...
      if (reportdata && reportdata.InitialDraftReport) {
        ...
        this.socialform.patchValue({
          social1: this.initialDraftReport[15]['social205aQuestion1'],
  ...
  onSave() {
    var social205aQuestion1 = this.socialform.get('social1').value;
  
    this.initialDraftReport[15] = {social205aQuestion1}
    // this.sgx.sgxanswers[15]=this.initialDraftReport;
    ...
    this.sgx.sgxanswers[15]=currentInitialDraftReport[15];
    ...
    this.sgx.GetSGX_ReportGenerationByReportId(this.reportid).subscribe((data) => {
        ...
        if(init!=null){
        init[15]=this.sgx.sgxanswers[15]
