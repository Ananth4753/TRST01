...
@Component({
  selector: 'app-sgx_dynamicreport',
  templateUrl: './sgx_dynamicreport.component.html',
  styleUrls: ['./sgx_dynamicreport.component.scss']
})
export class Sgx_dynamicreportComponent implements OnInit {
