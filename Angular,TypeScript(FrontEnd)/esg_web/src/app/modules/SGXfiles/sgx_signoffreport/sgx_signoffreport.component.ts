...
import { Sgx_signoffreportService } from './sgx_signoffreport.service';
...
@Component({
  selector: 'app-sgx_signoffreport',
  templateUrl: './sgx_signoffreport.component.html',
  styleUrls: ['./sgx_signoffreport.component.scss']
})
export class Sgx_signoffreportComponent implements OnInit {
  reportid: any;
  reportname: any;
  reportstartdate: any;
  reportenddate: any;
  ...
  constructor(
    ...
    private signoffreportservice:Sgx_signoffreportService,
