...
@Component({
  selector: 'app-sgx_templatetwo',
  templateUrl: './sgx_templatetwo.component.html',
  styleUrls: ['./sgx_templatetwo.component.scss']
})
export class Sgx_templatetwoComponent implements OnInit {
