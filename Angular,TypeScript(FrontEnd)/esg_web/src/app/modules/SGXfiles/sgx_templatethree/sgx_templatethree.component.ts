...
@Component({
  selector: 'app-sgx_templatethree',
  templateUrl: './sgx_templatethree.component.html',
  styleUrls: ['./sgx_templatethree.component.scss']
})
export class Sgx_templatethreeComponent implements OnInit {
