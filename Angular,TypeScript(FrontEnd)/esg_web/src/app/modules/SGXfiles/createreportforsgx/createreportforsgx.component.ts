...
import { CreatereportforsgxService } from './createreportforsgx.service';
...
@Component({
  selector: 'app-createreportforsgx',
  templateUrl: './createreportforsgx.component.html',
  styleUrls: ['./createreportforsgx.component.scss']
})
export class CreatereportforsgxComponent implements OnInit {
 ...
 this.reportform.get('EndDate').setValue(theLast)
  ...
  next(){
    ...
    this.cs.Updatereport(obj).subscribe((data)=>{
      ...
      this.st.updateSGXStage(obj1).subscribe((data1)=>{
