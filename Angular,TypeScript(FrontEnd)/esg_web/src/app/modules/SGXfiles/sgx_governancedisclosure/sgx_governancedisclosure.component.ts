...
@Component({
  selector: 'app-sgx_governancedisclosure',
  templateUrl: './sgx_governancedisclosure.component.html',
  styleUrls: ['./sgx_governancedisclosure.component.scss']
})
export class Sgx_governancedisclosureComponent implements OnInit {
  reportid: any;
  reportname: any;
  templatemenu: any;
  designtemplate: any;
