...
@Component({
  selector: 'app-sgx_templatefive',
  templateUrl: './sgx_templatefive.component.html',
  styleUrls: ['./sgx_templatefive.component.scss']
})
export class Sgx_templatefiveComponent implements OnInit {
