...
@Component({
  selector: 'app-remarkspreenvironment',
  templateUrl: './remarkspreenvironment.component.html',
  styleUrls: ['./remarkspreenvironment.component.scss']
})
export class RemarkspreenvironmentComponent implements OnInit {
  reportid:any;
  reportname:any
  templatemenu: any;
  qaa:any;
