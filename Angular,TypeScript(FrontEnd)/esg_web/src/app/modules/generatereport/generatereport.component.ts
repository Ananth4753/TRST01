...
import { PreviewreportComponent } from '../previewreport/previewreport.component';
...
import { TableofcontentsComponent } from '../tableofcontents/tableofcontents.component';
...
export class GeneratereportComponent implements OnInit {
  ...
  constructor(private AuthService: AuthService,
    ...
    private gsService:GeneratereportService,
  ...
  ngOnInit() {
    ...
    (this.tableofcontent1=TableofcontentsComponent),
...
this.string = this.string.substring(0, this.string.length-1);
  ...
  if (result.dismiss === Swal.DismissReason.timer) {
    ...
    this.gsService.GetblockchainReportJsonByReportId(this.reportid).subscribe((resu) => {
       var url = `<a target="_blank" href='https://testnet.algoexplorer.io/tx/${resu['txId']}'>Click to verify Blockchain Transaction</a>`
      Swal.fire({
        imageUrl: './assets/img/blockchainpublished.png',
