...
@Component({
  selector: 'app-remarksmateriality',
  templateUrl: './remarksmateriality.component.html',
  styleUrls: ['./remarksmateriality.component.scss']
})
export class RemarksmaterialityComponent implements OnInit {
  reportid:any;
  reportname:any
  templatemenu: any;
  qaa:any;
  ...
  this.materialityform = this.fb.group({
    materiality1:[''],
    materiality2:[''],
    materiality3:[''],
    materiality4:[''],
...
Save(){
  let formva=this.materialityform.value
  //console.log(formva);
