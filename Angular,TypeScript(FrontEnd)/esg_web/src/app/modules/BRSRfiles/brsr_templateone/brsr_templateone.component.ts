...
@Component({
  selector: 'app-brsr_templateone',
  templateUrl: './brsr_templateone.component.html',
  styleUrls: ['./brsr_templateone.component.scss']
})
export class Brsr_templateoneComponent implements OnInit {
  reportid:any;
  reportname:any
  reportstartdate:any;
  reportenddate:any;
