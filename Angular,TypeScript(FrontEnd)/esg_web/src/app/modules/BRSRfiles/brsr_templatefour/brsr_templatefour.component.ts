...
@Component({
  selector: 'app-brsr_templatefour',
  templateUrl: './brsr_templatefour.component.html',
  styleUrls: ['./brsr_templatefour.component.scss']
})
export class Brsr_templatefourComponent implements OnInit {
  reportid:any;
  reportname:any
  reportstartdate:any;
  reportenddate:any;
