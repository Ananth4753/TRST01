...
@Component({
  selector: 'app-brsr_templatethree',
  templateUrl: './brsr_templatethree.component.html',
  styleUrls: ['./brsr_templatethree.component.scss']
})
export class Brsr_templatethreeComponent implements OnInit {
  reportid:any;
  reportname:any
  reportstartdate:any;
  reportenddate:any;
