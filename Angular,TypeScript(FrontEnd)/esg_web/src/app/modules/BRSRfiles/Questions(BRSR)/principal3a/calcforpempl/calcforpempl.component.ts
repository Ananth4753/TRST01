...
@Component({
  selector: 'app-calcforpempl',
  templateUrl: './calcforpempl.component.html',
  styleUrls: ['./calcforpempl.component.scss']
})
export class CalcforpemplComponent implements OnInit {
  ghForm:FormGroup
  constructor(public dialog: MatDialog,private fb:FormBuilder,private cdRef: ChangeDetectorRef,private sbrs:SelectbrsrService,
    @Inject(MAT_DIALOG_DATA) private _data: any,private router:Router,public matDialogRef:MatDialogRef<CalcforpemplComponent>) { 
  }
