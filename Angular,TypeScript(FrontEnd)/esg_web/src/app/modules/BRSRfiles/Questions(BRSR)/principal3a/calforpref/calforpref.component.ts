...
@Component({
  selector: 'app-calforpref',
  templateUrl: './calforpref.component.html',
  styleUrls: ['./calforpref.component.scss']
})
export class CalforprefComponent implements OnInit {
  ghForm:FormGroup
  constructor(public dialog: MatDialog,private fb:FormBuilder,private cdRef: ChangeDetectorRef,private sbrs:SelectbrsrService,
    @Inject(MAT_DIALOG_DATA) private _data: any,private router:Router,public matDialogRef:MatDialogRef<CalforprefComponent>) { 
  }
  ngOnInit() {
