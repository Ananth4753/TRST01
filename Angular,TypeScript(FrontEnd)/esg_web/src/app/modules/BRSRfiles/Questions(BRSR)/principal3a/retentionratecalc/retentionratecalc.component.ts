...
@Component({
  selector: 'app-retentionratecalc',
  templateUrl: './retentionratecalc.component.html',
  styleUrls: ['./retentionratecalc.component.scss']
})
export class RetentionratecalcComponent implements OnInit {
  ghForm:FormGroup
  constructor(public dialog: MatDialog,private fb:FormBuilder,private cdRef: ChangeDetectorRef,private sbrs:SelectbrsrService,
    @Inject(MAT_DIALOG_DATA) private _data: any,private router:Router,public matDialogRef:MatDialogRef<RetentionratecalcComponent>) { 
  }
