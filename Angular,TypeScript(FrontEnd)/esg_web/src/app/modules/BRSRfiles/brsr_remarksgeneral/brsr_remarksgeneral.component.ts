...
import { UploadimgComponent } from 'app/modules/remarksgeneral/uploadimg/uploadimg.component';
...
@Component({
  selector: 'app-brsr_remarksgeneral',
  templateUrl: './brsr_remarksgeneral.component.html',
  styleUrls: ['./brsr_remarksgeneral.component.scss']
})
export class Brsr_remarksgeneralComponent implements OnInit {
  reportid: any;
  reportname: any;
  templatemenu: any;
  designtemplate: any;
