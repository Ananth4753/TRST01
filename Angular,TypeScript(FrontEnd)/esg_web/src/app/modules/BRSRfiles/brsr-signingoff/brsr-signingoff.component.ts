...
import { ValidatingreportscreenService } from 'app/modules/validatingreportscreen/validatingreportscreen.service';
...
import { Sgx_introreportComponent } from 'app/modules/SGXfiles/sgx_introreport/sgx_introreport.component';
import { DynamiccontentComponent } from 'app/modules/dynamiccontent/dynamiccontent.component';
...
@Component({
  selector: 'app-brsr-signingoff',
  templateUrl: './brsr-signingoff.component.html',
  styleUrls: ['./brsr-signingoff.component.scss']
})
export class BrsrSigningoffComponent implements OnInit {
  reportid: any;
  reportname: any;
  reportstartdate: any;
  reportenddate: any;
  ...
  constructor(
    ...
    private vrs:ValidatingreportscreenService,
  ...
  ngOnInit(): void {
    ...
    (this.generaldisclosure=Brsr_generaldisclosureComponent),
    (this.management=Brsr_managementComponent),
    (this.principals=Brsr_principalsreportComponent),
