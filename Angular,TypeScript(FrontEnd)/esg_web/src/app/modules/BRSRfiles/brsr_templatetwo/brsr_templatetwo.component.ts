...
@Component({
  selector: 'app-brsr_templatetwo',
  templateUrl: './brsr_templatetwo.component.html',
  styleUrls: ['./brsr_templatetwo.component.scss']
})
export class Brsr_templatetwoComponent implements OnInit {
  reportid:any;
  reportname:any
  reportstartdate:any;
  reportenddate:any;
