...
import { Brsr_validateService } from './brsr_validate.service';
...
@Component({
  selector: 'app-brsr_validate',
  templateUrl: './brsr_validate.component.html',
  styleUrls: ['./brsr_validate.component.scss']
})
export class Brsr_validateComponent implements OnInit {
  reportid: any;
  reportname: any;
  reportstartdate: any;
  reportenddate: any;
  ...
  constructor(
    ...
    private ss: Brsr_validateService,
  ...
  validate1() {
    this.router.navigate(['/brsr_generatereport', this.reportid]);
  }
}
