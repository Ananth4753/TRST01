...
@Component({
  selector: 'app-brsr_remarksmanagement',
  templateUrl: './brsr_remarksmanagement.component.html',
  styleUrls: ['./brsr_remarksmanagement.component.scss']
})
export class Brsr_remarksmanagementComponent implements OnInit {
 ...
 // public answerValues2: any[] = [];
  ...
  Save(){
    let formva=this.managementform.value
    //console.log(formva);
