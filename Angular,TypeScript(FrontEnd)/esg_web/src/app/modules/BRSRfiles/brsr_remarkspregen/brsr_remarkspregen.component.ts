...
@Component({
  selector: 'app-brsr_remarkspregen',
  templateUrl: './brsr_remarkspregen.component.html',
  styleUrls: ['./brsr_remarkspregen.component.scss']
})
export class Brsr_remarkspregenComponent implements OnInit {
  reportid:any;
  reportname:any
  templatemenu: any;
  qaa:any;
