...
@Component({
  selector: 'app-brsr_remarkspreprinci',
  templateUrl: './brsr_remarkspreprinci.component.html',
  styleUrls: ['./brsr_remarkspreprinci.component.scss']
})
export class Brsr_remarkspreprinciComponent implements OnInit {
  reportid:any;
  reportname:any
  templatemenu: any;
  qaa:any;
