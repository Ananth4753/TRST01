...
export class SelectfortemplateService {

  constructor(private _httpClient: HttpClient) { }

  getTemplateDetails(): Observable<any[]> {
    const apiUrl = `${baseUrl}/TemplateGeneration/GetTemplateGenerationDetails`;
    return this._httpClient.get<any[]>(apiUrl);
  }

  geTemplateIdDetailsById(Id:any): Observable<any[]> {              
    const apiUrl = `${baseUrl}/TemplateGeneration/GetTemplateGenerationById/${Id}`;   
     return this._httpClient.get<any[]>(apiUrl);
  }

  // pushselected(selectedItems: any): Observable<any> {
  //   const apiUrl = `${baseUrl}/TemplateGeneration/AddTemplateCheckboxMenuId`;
  ...
  pushselected(selectedItems: any): Observable<any> {
    const apiUrl = `${baseUrl}/ReportGeneration/AddReportTemplateMenuIdforTemplate`;
    return this._httpClient.post<any>(apiUrl, selectedItems);
  }
