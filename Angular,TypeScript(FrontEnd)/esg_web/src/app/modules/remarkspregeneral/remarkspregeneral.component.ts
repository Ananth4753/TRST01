...
@Component({
  selector: 'app-remarkspregeneral',
  templateUrl: './remarkspregeneral.component.html',
  styleUrls: ['./remarkspregeneral.component.scss']
})
export class RemarkspregeneralComponent implements OnInit {
  reportid:any;
  reportname:any
  templatemenu: any;
  qaa:any;
