...
@Component({
  selector: 'app-remarkseconomic',
  templateUrl: './remarkseconomic.component.html',
  styleUrls: ['./remarkseconomic.component.scss']
})
export class RemarkseconomicComponent implements OnInit {
  property:number = 10;
  ...
  constructor(private route:ActivatedRoute,private aa:ActivatedRoute,private AuthService:AuthService,private apps:AppService,
    private importservice:ImportdisService,
    private vrs:ValidatingreportscreenService,private dds:DynamiccontentService,private ss:SelectdisService,private crs:CreatereportService,private us:UpdatereportService,private is:ImagereportService,
  ...
  // this.ecoform.valueChanges.subscribe(value => {
  //  // console.log(value);
  ...
  //     const newRemarks = {
  //       ...existingRemarks,
  //       ...value // Assuming the 'value' is an object containing new data to be added
  //     };
  ...
  //       IsValidate: 1,
  //       Remarks: newRemarks, // Convert the merged data back to JSON format before saving
  ...
  //     };
  //     this.vrs.addfinalreportvalidation(updatedBoxes).subscribe((final) => {
  //       //console.log(final);
  //     });
  //   });
  // });
