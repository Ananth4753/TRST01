...
import {TreeviewItem1Component} from '../treeview-item1/treeview-item.component1';
...
@Component({
  selector: 'ngx-treeview1',
  templateUrl: './treeview1.component.html',
  styleUrls: ['./treeview1.component.scss']
})
export class Treeview1Component implements OnChanges, OnInit {
  ...
  raiseSelectedChange(): void {
    this.generateSelection();
   // const values = this.eventParser.getSelectedChange1(this);
    // setTimeout(() => {
